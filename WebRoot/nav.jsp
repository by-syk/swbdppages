...
<div class="container">
  ...
  <div id="navBarMenu" class="collapse navbar-collapse">
    <ul class="nav navbar-nav">
      ...
      <li id="navCate"><a href="cate_manage.jsp"><i class="fa fa-server fa-fw"></i> 索引管理</a></li>
      <li id="navSys"><a href="sys_manage.jsp"><i class="fa fa-cog fa-fw"></i> 系统管理</a></li>
    </ul>
    <ul class="nav navbar-nav navbar-right">
      <li><a href="javascript:void(0);" onclick="$('#loginDlg').modal('show')">登录/注册</a></li>
    </ul>
  </div>
</div>
</nav>
